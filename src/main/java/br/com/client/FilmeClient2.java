...
public class FilmeClient2 {
	...
	public static void main(String[] args) throws IOException {
		FilmeEntradaDto entradaDto = new FilmeEntradaDto();
		entradaDto.setNome("Spring Boot Essentials 2 - Introdução ao curso");
		entradaDto.setDescricao("xxxxxxxxxx");
		entradaDto.setGenero("Spring Boot");
		entradaDto.setUrl("https://www.youtube.com/watch?v=bCzsSXE4Jzg&list=PL62G310vn6nFBIxp6ZwGnm8xMcGE3VA5H");		
		
		System.out.println(new FilmeClient2().criar(entradaDto));
	}
}
